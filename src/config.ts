...
export const SIDEBAR: Sidebar = {
  en: {
    ...
    Conditions: [{ text: "Conditions", link: "en/conditions/intro" }],
    "Condition Terms": [
      { text: "Equals", link: "en/conditions/terms/equals" },
      { text: "Not Equals", link: "en/conditions/terms/not-equals" },
      { text: "Contains", link: "en/conditions/terms/contains" },
      { text: "Doesn't Contain", link: "en/conditions/terms/not-contains" },
      { text: "Starts With", link: "en/conditions/terms/starts-with" },
      { text: "Doesn't Start With", link: "en/conditions/terms/not-starts-with" },
      { text: "Ends With", link: "en/conditions/terms/ends-with" },
      { text: "Doesn't End With", link: "en/conditions/terms/not-ends-with" },
      { text: "Before", link: "en/conditions/terms/before" },
      { text: "After", link: "en/conditions/terms/after" },
      { text: "Less Than", link: "en/conditions/terms/less-than" },
      { text: "Greater Than", link: "en/conditions/terms/greater-than" },
      { text: "Is Filled", link: "en/conditions/terms/is-filled" },
      { text: "Is Empty", link: "en/conditions/terms/is-empty" },
    ],
    "Condition Actions": [
      { text: "Show", link: "en/conditions/actions/show" },
      { text: "Hide", link: "en/conditions/actions/hide" },
      { text: "Require", link: "en/conditions/actions/require" },
      { text: "Un-Require", link: "en/conditions/actions/un-require" },
      { text: "Enable", link: "en/conditions/actions/enable" },
      { text: "Disable", link: "en/conditions/actions/disable" },
      { text: "Show Tab", link: "en/conditions/actions/show-tab" },
      { text: "Hide Tab", link: "en/conditions/actions/hide-tab" },
      { text: "Activate Tab", link: "en/conditions/actions/activate-tab" },
      { text: "Skip To Field", link: "en/conditions/actions/skip-to-field" },
      { text: "Show Message", link: "en/conditions/actions/show-message" },
      { text: "Clear", link: "en/conditions/actions/clear" },
