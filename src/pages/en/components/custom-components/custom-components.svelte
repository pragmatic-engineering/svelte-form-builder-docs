<script lang="ts">
  ...
  let options: BuilderOptions = {
    componentOptions: [
      {
        importPath: "/src/components/ExampleTestCustomComponents/Custom1-Marquee.svelte",
        componentName: "Custom 1",
        icon: "🎁",
      },
      {
        importPath: "/src/components/ExampleTestCustomComponents/Custom3-Text.svelte",
        componentName: "Custom Text",
...
<FormBuilderWrapper options="{options}" showComponents="{['']}" />
